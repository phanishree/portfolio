...
export default function WorkExperience() {
    ...
    return (
        <div className="w-[100vw] h-[100vh] flex flex-col bg-white relative">
            ...
            <div className="flex-1 overflow-y-auto p-4 relative">
                <motion.header
                    ...
                    className="absolute left-10 top-20 text-2xl sm:text-3xl md:text-4xl font-bold p-4 rounded-lg bg-transparent flex items-center space-x-2"
                >
                    <h1 className="text-black font-bold text-[4vw] sm:text-[6vw] md:text-[6vw] lg:text-[3vw]">
                        Software Engineer @
                    </h1>
                    <motion.img
                ...
                {/* Add additional scrollable content here */}
                <div className="mt-[150px] text-black text-center">
                    <p>Let him cook !!!!!</p>
